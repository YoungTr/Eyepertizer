...
package com.eyepertizer.androidx.ui.web
...
import com.eyepertizer.androidx.databinding.ActivityWebViewBinding
import com.eyepertizer.androidx.extension.preCreateSession
...
import com.eyepertizer.androidx.util.vassonic.OfflinePkgSessionConnection
import com.eyepertizer.androidx.util.vassonic.SonicJavaScriptInterface
import com.eyepertizer.androidx.util.vassonic.SonicRuntimeImpl
import com.eyepertizer.androidx.util.vassonic.SonicSessionClientImpl
...
class WebViewActivity : BaseActivity() {
    ...
    private fun initTitleBar() {
        ...
        binding.titleBar.ivShare.setOnClickListener { showDialogShare(this, "${title}:${linkUrl}") }
    }
